...
function Widget(props) {
    useEffect(() => {
        ...
        link.setAttribute("href", "https://cdn.jsdelivr.net/gh/stward1/staticFileTest/static/css/main.49542669.css");
        link.setAttribute("rel", "stylesheet");
        document.getElementsByClassName("crewi-embed")[0].appendChild(link);

        const script = document.createElement("script");
        script.setAttribute("class", "crewi_script");
        script.setAttribute("src", "https://cdn.jsdelivr.net/gh/stward1/staticFileTest/static/js/787.d1453236.chunk.js");
